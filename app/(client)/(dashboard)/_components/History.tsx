      ...
      <Card className="mt-2 w-full">
        ...
        <CardContent>
          <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                ...
                <BarChart height={300} data={historyDataQuery.data} barCategoryGap={5}>
                  <defs>
                    ...
                    <linearGradient id="expenseBar" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0" stopColor="#ed4444" stopOpacity="1" />
                      <stop offset="1" stopColor="#ed4444" stopOpacity="0" />
                    </linearGradient>
                  </defs>
            ...
            {!dataAvailable && (
              <Card className="flex flex-col items-center justify-center bg-background h-[300px]">

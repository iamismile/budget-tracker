  ...
  return (
    <div className="w-full flex flex-wrap gap-2 md:flex-nowrap">
      <SkeletonWrapper isLoading={statsQuery.isFetching}>
        <CategoriesCard type="income" formatter={formatter} data={statsQuery.data || []} />
      </SkeletonWrapper>

      <SkeletonWrapper isLoading={statsQuery.isFetching}>
        <CategoriesCard type="expense" formatter={formatter} data={statsQuery.data || []} />
      </SkeletonWrapper>
    </div>
  );
}
    ...
    <Card className="h-80 w-full col-span-6">
      ...
      <div className="flex items-center justify-between gap-2">
        {filteredData.length === 0 && (
          <div className="flex flex-col items-center justify-center w-full h-60 text-center">
